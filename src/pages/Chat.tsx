...
export default function Chat() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden inset-0 bg-gradient-to-br from-pink-950 via-slate-900 to-blue-950">
        {/* <div
        ...
        <div className="fixed inset-0 bg-black/50" />
            ...
            <div className="relative z-10 flex min-h-screen justify-end">
                <div className="fixed top-4 left-3 z-20">
                    <a
                        href= "/quizforge.html"
                        className="rounded-2xl border border-white/10 bg-zinc-950/80 px-4 py-2 text-white shadow-xl backdrop-blur-xl transition hover:bg-white/10"
                    >
                        Go Home
                    </a>
                </div>
